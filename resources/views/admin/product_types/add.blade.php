        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-body">
                            {!! Form::open(['method' => 'POST', 'url' => 'admin/product_types/add', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('category_id', ['' => 'Chọn danh mục'] + $categories, '', ['class' => 'form-control width-400']) !!}
                            </div>
